    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "উফ্স এত ডাকলে কেন left নিবো",
          "- থাপ্পড় চিনোস থাপ্পড়- 👋👋😡 -চিন্তা করিস না তরে মারমু না-🤗-বস রবিউল আমারে মারছে - 🥱 - উফফ সেই স্বাদ..!🥵🤤💦",
          "hmmm jan inbox এ নক দাও🙈"
          "এড ডাকিস কেন তুই তোর জন্য শান্তি মত একটু মেকাআপ করতে পারি নাহ🤬",
          "খোদা একটা মন দিলো,কিন্তু মনের মানুষ দিলো না...রে!🤧",
          "-⎯͢⎯⃝এ'ড'মি'নে'র' E'x এ'র অ'লি'তে' গ'লি'তে' উ'ম্মা'হ'-🥺⎯͢⎯⃝🩷🍒",
          "Facbook আমাকে কিছুই দেয় নি🥹..!শুধু কেরে নিছে হাজারো MB",
          "ফেসবুক আমাকে তাবিজ করছে মনে হয়😒হুদাই একটু পর পর লাইনে আসি",
          "❥𒊹︎─༊ আজ আম্মুকে বলেছিলাম “বিরিয়ানি খাবো”🙂❥┼─༊আম্মু শুনেছে “বিরি খাবো। 🙄❥তারপর শুরু হলো থাপড়ানি 😤😠এখন আমি ডান কানে কম শুনি..🙂🙂",
          "আমাকে ডাকলে কিস দিয়ে দৌড় দিমু🏃‍♀️🏃‍♀️"
        ];
